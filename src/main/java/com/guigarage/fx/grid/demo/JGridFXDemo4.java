		...
		public ColoredAndAnimatedGridCell() {
			addEventHandler(MouseEvent.MOUSE_ENTERED, new EventHandler<MouseEvent>() {
				...
				public void handle(MouseEvent arg0) {
					...
					rotateInTransition = RotateTransitionBuilder.create().fromAngle(ColoredAndAnimatedGridCell.this.getRotate()).toAngle(16).interpolator(Interpolator.EASE_IN).duration(Duration.millis(200)).node(ColoredAndAnimatedGridCell.this).build();
					scaleInTransition = ScaleTransitionBuilder.create().fromX(ColoredAndAnimatedGridCell.this.getScaleX()).toX(1.3).fromY(ColoredAndAnimatedGridCell.this.getScaleY()).toY(1.3).interpolator(Interpolator.EASE_IN).duration(Duration.millis(200)).node(ColoredAndAnimatedGridCell.this).build();
			...
			addEventHandler(MouseEvent.MOUSE_EXITED, new EventHandler<MouseEvent>() {
				...
				public void handle(MouseEvent arg0) {
					...
					rotateOutTransition = RotateTransitionBuilder.create().fromAngle(ColoredAndAnimatedGridCell.this.getRotate()).toAngle(0).interpolator(Interpolator.EASE_OUT).duration(Duration.millis(120)).node(ColoredAndAnimatedGridCell.this).build();
					scaleOutTransition = ScaleTransitionBuilder.create().fromX(ColoredAndAnimatedGridCell.this.getScaleX()).toX(1.0).fromY(ColoredAndAnimatedGridCell.this.getScaleY()).toY(1.0).interpolator(Interpolator.EASE_OUT).duration(Duration.millis(120)).node(ColoredAndAnimatedGridCell.this).build();
